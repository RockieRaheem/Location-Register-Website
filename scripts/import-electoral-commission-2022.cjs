...
const outputPath = path.join(projectRoot, 'data', 'uganda-electoral-commission-2022.json');
const reportPath = path.join(projectRoot, 'data', 'uganda-electoral-commission-2022.import-report.json');
